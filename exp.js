...
\
<p>其中【维度】是从能力, 道德, 社交能力, 外貌, 社会经济地位五个维度中随机选出的，您需要对该段描述进行1-9分的评分，其中1分表示非常不同意，9分表示非常同意。评分采用鼠标点击相应数字进行评分，在每次评分后请按“空格键”继续。</p> \
<p>其中：</p> \
...
<p>您需要对词语的积极/消极程度进行1-9分的评分，其中1分表示非常消极，9分表示非常积极。评分采用鼠标点击相应数字进行评分，在每次评分后请按“空格键”继续。</p>\
