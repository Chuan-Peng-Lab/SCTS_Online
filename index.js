    ...
    return {
        timeline: [
           ...
           \
            ...
            <p class='para'><strong>首先</strong>，您需要对<strong>每个呈现在屏幕上的词语根据提示语进行评分</strong>，评分没有正误之分，根据您的理解和直觉进行评分即可。在评分之前，我们会告诉您需要进行评分的维度以及其意义。您将会对318/319个词语从五个维度分别进行评分，这五个维度分别为：能力、道德、社交能力、外貌、社会经济地位。不同的维度不同时出现。</p>\
            <p class='para'><strong>其次</strong>，您需要对词语进行效价评分，即对词语的积极/消极程度进行1-9分评分。</p>\
            <p class='para'><strong>最后</strong>，在正式进入实验前，若您对实验的指导语或者本实验还有不清楚之处，可咨询实验员（即联系您参加实验的同学/老师）。</p>\
            </div> </div>",
            ...
            <p class='para'><strong>收益：</strong>您在本实验中的主要收益是您对于科学研究的贡献！同时，为了补偿您参加研究所花费的时间和精力，我们将给予您一定的经济补偿（￥20）。该经济补偿将通过腾讯问卷进行发放）。</p>\
