    ...
    return {
        timeline: [
           ...
           \
            ...
            <p class='para'><strong>第一部分，</strong>您需要对<strong>每个呈现在屏幕上的词语根据提示语进行评分</strong>，评分没有正误之分(<strong>注意力检测题除外</strong>)，根据您的理解和直觉进行评分即可。在评分之前，我们会告诉您需要进行评分的维度及其意义。您将会对318或319个词语从五个维度分别进行评分，这五个维度分别为：能力、道德、社交能力、外貌、社会经济地位，不同维度的评分随机交替出现。这些词可能有积极词，也可能有消极词，此时请您不要根据积极和消极进行评分，而是依据该词是否适合用来描述该维度进行评分。</p>\
            ...
            <p class='para'><strong>收益：</strong>您在本实验中的主要收益是您对于科学研究的贡献！同时，为了补偿您参加研究所花费的时间和精力，我们将给予您一定的经济补偿 (¥20或者¥50)，该经济补偿将通过腾讯问卷进行发放。为保证本研究的数据质量，本问卷设置了几个注意力的检测题，这几个题目的答案非常明显，如果您觉得是就选非常同意，不是就选非常不同意，不要选其他选项，但是对于其他题目可以按照自己的看法去评分。注意力检测题回答如果不符合常识，即被判断为错误。如果有1道及以上注意力检测题回答错误，或者实验中有明显随意填写的情况，您的数据会被提前设置好的程序自动识别为无效。如果这种情况发生，您的数据将无法纳入到最终的数据分析之中，您的报酬为20元。希望您能够理解本研究的设定，认真对待实验。当然，如果您认为本研究的这个设定不符合您的偏好，您有权选择不参加本次实验。</p>\
            ...
            <p class='para'><strong>自愿参与：</strong>是否参加本研究完全由您自愿决定。但是，参加本研究的前提是您理解本研究的指导语、实验流程和相关设置，并表示接受。如果您不理解本研究的指导语、实验流程和关于数据有效性的检测，您将无法参加这项研究。</p>\
            <p class='para'><strong>退出实验的权利：</strong>您有权在实验中的任何阶段退出本次实验，不会有任何的惩罚。我们会根据您完成实验的情况，补偿您在本实验所花费的时间。</p>\
            <p class='para'><strong>如何退出：</strong>如果您决定退出本次实验，请告知实验员，我们会立即终止实验。 如果您有任何疑问，请联系：胡传鹏教授（南京师范大学心理学院，江苏省南京市鼓楼区宁海路122号，210024；Email: hu.chuan-peng@nnu.edu.cn；Tel: 15910258380）</p>\
            <p class='para'><strong>同意书：</strong>如果您点击“继续”按键继续实验，代表您已经理解了本研究的指导语、研究的流程和关于数据有效性的设置，也同意向未来的研究者共享您的数据。</p>\
