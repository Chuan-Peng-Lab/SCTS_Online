    ...
    return {
        timeline: [
           ...
           \
            ...
            <p class='para'><strong>第一部分，</strong>您需要对<strong>每个呈现在屏幕上的词语根据提示语进行评分</strong>，评分没有正误之分(注意力检测题除外)，根据您的理解和直觉进行评分即可。在评分之前，我们会告诉您需要进行评分的维度及其意义。您将会对318或319个词语从五个维度分别进行评分，这五个维度分别为：能力、道德、社交能力、外貌、社会经济地位，不同维度的评分随机交替出现。这些词可能有积极词，也可能有消极词，此时请您不要根据积极和消极进行评分，而是依据该词是否适合用来描述该维度进行评分。</p>\
