    ...
    return {
        timeline: [
           ...
           \
            ...
            <p class='para'><strong>首先</strong>，您需要对<strong>每个呈现在屏幕上的词语根据提示语进行评分</strong>，评分没有正误之分，根据您的理解和直觉进行评分即可。在评分之前，我们会告诉您需要进行评分的维度及其意义。您将会对318/319个词语从五个维度分别进行评分，这五个维度分别为：能力、道德、社交能力、外貌、社会经济地位。不同的维度不同时出现。</p>\
